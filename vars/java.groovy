    ...
    stage('Create Docker images') {
      ...
      container('docker') {
          ...
          sh """
            ...
            docker build -t registry.iyzico.net/halit.soydemir/${pipelineParams.registeryName}:${env.BUILD_NUMBER} .

            docker images
            
            docker push registry.iyzico.net/halit.soydemir/${pipelineParams.registeryName}:${env.BUILD_NUMBER}
